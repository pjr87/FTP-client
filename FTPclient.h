...
public:
	 ...
	 * The argument is a HOST-PORT specification for the data port
		...
		address.
	 */
	int PORT(string host, string port);
	 ...
	 */
	int EPRT(string ipType, string host, string port);
	...
	/*
	 * createFile - creates a file locally after received from FTP
	 */
	int createFile(string filename, string data);

	Socket control; //Socket which sends control messages to FTP server
	Socket dataSock; //Socket which handles data between FTP and client
private:
